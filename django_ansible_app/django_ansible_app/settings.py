"""
Django settings for django_ansible_app project.
...
SECRET_KEY = 'django-insecure-wrnt#rj3*b4vcx__g_w%)*@mi8$5hai3aez_2h8mylfv19n^+#'
...
# Optional: Use Django's built-in templates for error handling
LOGIN_URL = 'login'  # Redirect unauthorized access to login
